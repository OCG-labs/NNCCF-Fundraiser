...
if(!class_exists('WDF_Gateway')) {
	class WDF_Gateway {
		...
		function _construct() {
			...
			add_action('wdf_gateway_process_fixed_'.$this->plugin_name, array(&$this,'process_fixed'), 10);
			add_action('wdf_gateway_process_event_'.$this->plugin_name, array(&$this,'process_event'), 10);
			...
			add_action('wdf_gateway_process_recur_cancel_'.$this->plugin_name, array(&$this,'process_recur_cancellation'), 10);
      ...
      $this->ipn_url = admin_url('admin-ajax.php?action=wdf-ipn-return-'.$this->plugin_name);
			 ...
			 add_action( 'wp_ajax_wdf-ipn-return-'.$this->plugin_name, array($this,'handle_ipn') );
