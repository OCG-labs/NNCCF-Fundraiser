						...
						case 'other' : ?>
							...
							<table class="form-table" id="wdf_permalink_settings">
								<tbody>
									...
									<tr valign="top">
										<th scope="row">
											<label><?php _e('Payment Error Page','wdf'); ?></label>
										</th>
										<td>
											<span class="code"><?php echo home_url().$front_permlink.'/'.$settings['dir_slug'].'/{The Fundraiser\'s Name}/'; ?></span><input id="wdf_error_slug" type="text" name="wdf_settings[error_slug]" value="<?php echo esc_attr($settings['error_slug']); ?>" />
										</td>
									</tr>
									<?php endif; ?>
								</tbody>
						...
						case 'payments' : ?>
							...
							<table class="form-table">
								<tbody>
									...
									<tr valign="top">
										<th scope="row">
											<label><?php _e('Fixed Price Donation','wdf'); ?></label>
										</th>
										<td>
											<input class="wdf_auto_submit" type="checkbox" name="wdf_settings[payment_types][]" value="fixed" <?php checked( in_array( 'fixed', $settings['payment_types'] ), true ); ?> />
											<?php echo $tips->add_tip(__('Fixed price fundraisers allows you to specify the fixed amount for the donation.','wdf')); ?>
										</td>
									</tr>
									<tr valign="top">
										<th scope="row">
											<label><?php _e('Event Fundraiser','wdf'); ?></label>
										</th>
										<td>
											<input class="wdf_auto_submit" type="checkbox" name="wdf_settings[payment_types][]" value="event" <?php checked( in_array( 'event', $settings['payment_types'] ), true ); ?> />
											<?php echo $tips->add_tip(__('Event fundraisers allows you to include information about the individuals/groups that are signing up.','wdf')); ?>
										</td>
									</tr>
									<tr valign="top">
										<th scope="row">
